...
- https://gclb.github.io/y-grpc-gateway/
...
### 4. Generate reverse-proxy using `protoc-gen-grpc-gateway`
  ...
  #### 2. With custom annotations
   ...
   [Check our documentation](https://gclb.github.io/y-grpc-gateway/docs/mapping/grpc_api_configuration/)
...
### 6. (Optional) Generate OpenAPI definitions using `protoc-gen-openapiv2`
   ...
   `buf`, you can add the `buf.build/guiguzi/y-grpc-gateway` dependency
   to your `deps` array:
   ```yaml
   version: v1
   name: buf.build/yourorg/myprotos
   deps:
     - buf.build/googleapis/googleapis
     - buf.build/guiguzi/y-grpc-gateway
   ```
   ...
   [Customizing Your Gateway](https://gclb.github.io/y-grpc-gateway/docs/mapping/customizing_your_gateway/)
...
Note that usage of remote plugins is incompatible with usage of external configuration files like [grpc_api_configuration](https://gclb.github.io/y-grpc-gateway/docs/mapping/grpc_api_configuration/#using-an-external-configuration-file).
...
- Automatically translating PATCH requests into Field Mask gRPC requests. See
  [the docs](https://gclb.github.io/y-grpc-gateway/docs/mapping/patch_feature/)
  for more information.
